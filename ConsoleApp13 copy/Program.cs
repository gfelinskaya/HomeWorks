    ...
    internal class Program
    {
        static void Main()
        {
          ...
          begin:
            ...
            if (int.TryParse(size, out int desiredGoodSize) == true) // якщо така умова являється істиною
            {
                ...
                if (double.TryParse(minPrice, out double minimumPrice) == true &&
                    double.TryParse(maxPrice, out double maximumPrice) == true)
                {                  
                    if (goodColor == good1Color &&
                        desiredGoodSize == good1Size &&
